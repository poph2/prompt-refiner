const pokemons = [
    ...
    "Mawile", "Aron", "Lairon", "Aggron", "Meditite", "Medicham", "Electrike", "Manectric", "Plusle", "Minun", "Volbeat", "Illumise",
    "Roselia", "Gulpin", "Swalot", "Carvanha", "Sharpedo", "Wailmer", "Wailord", "Numel", "Camerupt", "Torkoal", "Spoink", "Grumpig",
    ...
    "Castform", "Kecleon", "Shuppet", "Banette", "Duskull", "Dusclops", "Tropius", "Chimecho", "Absol", "Wynaut", "Snorunt", "Glalie",
    "Spheal", "Sealeo", "Walrein", "Clamperl", "Huntail", "Gorebyss", "Relicanth", "Luvdisc", "Bagon", "Shelgon", "Salamence", "Beldum",
    ...
    "Staraptor", "Bidoof", "Bibarel", "Kricketot", "Kricketune", "Shinx", "Luxio", "Luxray", "Budew", "Roserade", "Cranidos", "Rampardos",
    "Shieldon", "Bastiodon", "Burmy", "Wormadam", "Mothim", "Combee", "Vespiquen", "Pachirisu", "Buizel", "Floatzel", "Cherubi", "Cherrim",
    ...
    "Dewott", "Samurott", "Patrat", "Watchog", "Lillipup", "Herdier", "Stoutland", "Purrloin", "Liepard", "Pansage", "Simisage",
    "Pansear", "Simisear", "Panpour", "Simipour", "Munna", "Musharna", "Pidove", "Tranquill", "Unfezant", "Blitzle", "Zebstrika",
    "Roggenrola", "Boldore", "Gigalith", "Woobat", "Swoobat", "Drilbur", "Excadrill", "Audino", "Timburr", "Gurdurr", "Conkeldurr",
    "Tympole", "Palpitoad", "Seismitoad", "Throh", "Sawk", "Sewaddle", "Swadloon", "Leavanny", "Venipede", "Whirlipede", "Scolipede",
    "Cottonee", "Whimsicott", "Petilil", "Lilligant", "Basculin", "Sandile", "Krokorok", "Krookodile", "Darumaka", "Darmanitan",
    ...
    "Reshiram", "Zekrom", "Landorus", "Kyurem", "Keldeo", "Meloetta", "Genesect", "Chespin", "Quilladin", "Chesnaught", "Fennekin",
    "Braixen", "Delphox", "Froakie", "Frogadier", "Greninja", "Bunnelby", "Diggersby", "Fletchling", "Fletchinder", "Talonflame",
    "Scatterbug", "Spewpa", "Vivillon", "Litleo", "Pyroar", "Flabébé", "Floette", "Florges", "Skiddo", "Gogoat", "Pancham", "Pangoro",
    "Furfrou", "Espurr", "Meowstic", "Honedge", "Doublade", "Aegislash", "Spritzee", "Aromatisse", "Swirlix", "Slurpuff", "Inkay",
    "Malamar", "Binacle", "Barbaracle", "Skrelp", "Dragalge", "Clauncher", "Clawitzer", "Helioptile", "Heliolisk", "Tyrunt", "Tyrantrum",
    "Amaura", "Aurorus", "Sylveon", "Hawlucha", "Dedenne", "Carbink", "Goomy", "Sliggoo", "Goodra", "Klefki", "Phantump", "Trevenant",
    ...
    "Lurantis", "Morelull", "Shiinotic", "Salandit", "Salazzle", "Stufful", "Bewear", "Bounsweet", "Steenee", "Tsareena", "Comfey",
    "Oranguru", "Passimian", "Wimpod", "Golisopod", "Sandygast", "Palossand", "Pyukumuku", "Type: Null", "Silvally", "Minior", "Komala",
    "Turtonator", "Togedemaru", "Mimikyu", "Bruxish", "Drampa", "Dhelmise", "Jangmo-o", "Hakamo-o", "Kommo-o", "Tapu Koko", "Tapu Lele",
    "Tapu Bulu", "Tapu Fini", "Cosmog", "Cosmoem", "Solgaleo", "Lunala", "Nihilego", "Buzzwole", "Pheromosa", "Xurkitree", "Celesteela",
    "Kartana", "Guzzlord", "Necrozma", "Magearna", "Marshadow", "Poipole", "Naganadel", "Stakataka", "Blacephalon", "Zeraora", "Meltan",
    "Melmetal"
];

const mythicalCreatures = [
    "Dragon", "Phoenix", "Mermaid", "Griffin", "Unicorn", "Kraken", "Centaur", "Sphinx", "Basilisk", "Cyclops",
    "Minotaur", "Fairy", "Elf", "Leprechaun", "Goblin", "Gargoyle", "Pegasus", "Chimera", "Satyr", "Werewolf",
    "Vampire", "Medusa", "Yeti", "Bigfoot", "Wendigo", "Siren", "Banshee", "Kitsune", "Nymph", "Troll",
    "Djinn", "Genie", "Manticore", "Hydra", "Thunderbird", "Cerberus", "Phoenix", "Leviathan", "Kelpie", "Fenghuang",
    "Qilin", "Baku", "Chupacabra", "Grindylow", "Cthulhu", "Fenrir", "Gorgon", "Jormungandr", "Kappa", "Lamia",
    "Naga", "Peryton", "Simurgh", "Tanuki", "Tengu", "Yuki-onna", "Ziz", "Cockatrice", "Dullahan", "Fenghuang",
    "Hippogriff", "Lindworm", "Nuckelavee", "Pixie", "Thunderbird", "Veela", "Bunyip", "Jackalope", "Kamaitachi", "Kappa",
    "Leshy", "Nue", "Nymph", "Qilin", "Selkie", "Shisa", "Sphinx", "Taniwha", "Wolpertinger", "Yeti",
    "Zaratan", "Adlet", "Bunyip", "Cerberus", "Dullahan", "Empusa", "Fomorian", "Gaasyendietha", "Harpy", "Hobgoblin",
    "Imp", "Jaculus", "Karkadann", "Lernaean Hydra", "Mngwa", "Nian", "Orthrus", "Pegasus", "Qiqirn", "Roc",
    "Salamander", "Teju Jagua", "Uchchaihshravas", "Vodyanoy", "Wendigo", "Xana", "Yara-ma-yha-who", "Zombie"
];
